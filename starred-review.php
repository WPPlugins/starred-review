...
Description: A small plugin that allows you to add reviews to your blog. You Need to <a href="?page=starred-review/starred-review.php&srpage=install">Install & Configure</a> this plugin before you can start using it. 
Version: 1.4
License: GPL
Author: Callum Alden
...
if (is_plugin_page()) {
	...
	function starredreview_admin_menu(){
		add_options_page('Starred Review Options', 'Starred Review', 8, "./options-general.php?page=starred-review/starred-review.php");
